...
| --- | --- | --- | --- |
| 1 | The settlement invariant works end to end. | PASS | forge test 73 passed / 0 failed; positive-proof.json=PASS; negative-proof.json only_eligible=true |
...
| 8 | Public evidence contains no raw merchant/customer record or credential. | PASS | privacy scan of 43 tracked files: 0 prohibited pattern(s); only the documented public anvil dev key is present |
...
- Full test suite: `forge test` (73 passing)
