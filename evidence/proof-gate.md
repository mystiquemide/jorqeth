...
| --- | --- | --- | --- |
| 1 | The winning invariant works end to end. | PASS | forge test 55 passed / 0 failed; positive-proof.json=PASS; negative-proof.json only_eligible=true |
...
- Full test suite: `forge test` (55 passing)
